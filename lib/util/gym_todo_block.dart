...
class GymToDoBlock extends StatefulWidget {

  final String taskName;
  bool taskComplete;
  Function(bool?)? onChanged;
  Function(BuildContext)? deleteTask;
  GymToDoBlock({super.key, required this.taskName, required this.taskComplete, required this.onChanged, required this.deleteTask});

  @override
  State<GymToDoBlock> createState() => _GymToDoBlockState();
}

class _GymToDoBlockState extends State<GymToDoBlock> {
  @override
              ...
              Checkbox(
                ...
                onChanged: (bool? newValue) {
                  setState(() {
                    ...
                    FirebaseFirestore.instance.collection('gymTasks').doc(widget.taskName).set({

...
class HouseToDoBlock extends StatefulWidget {

  final String taskName;
  bool taskComplete;
  Function(bool?)? onChanged;
  Function(BuildContext)? deleteTask;
  HouseToDoBlock({super.key, required this.taskName, required this.taskComplete, required this.onChanged, required this.deleteTask});

  @override
  State<HouseToDoBlock> createState() => _HouseToDoBlockState();
}

class _HouseToDoBlockState extends State<HouseToDoBlock> {
  @override
              ...
              Checkbox(
                ...
                onChanged: (bool? newValue) {
                  setState(() {
                    ...
                    FirebaseFirestore.instance.collection('houseTasks').doc(widget.taskName).set({

...
class SchoolToDoBlock extends StatefulWidget {

  final String taskName;
  bool taskComplete;
  Function(bool?)? onChanged;
  Function(BuildContext)? deleteTask;
  SchoolToDoBlock({super.key, required this.taskName, required this.taskComplete, required this.onChanged, required this.deleteTask});

  @override
  State<SchoolToDoBlock> createState() => _SchoolToDoBlockState();
}

class _SchoolToDoBlockState extends State<SchoolToDoBlock> {
  @override
              ...
              Checkbox(
                ...
                onChanged: (bool? newValue) {
                  setState(() {
                    ...
                    FirebaseFirestore.instance.collection('schoolTasks').doc(widget.taskName).set({
